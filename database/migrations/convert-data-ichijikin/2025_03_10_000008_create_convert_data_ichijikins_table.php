...
return new class extends Migration
{
    ...
    {
        Schema::create('convert_data_ichijikins', function (Blueprint $table) {
            $this->scheme($table, false);
        });

        Schema::create('_history_convert_data_ichijikins', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('convert_data_ichijikins');
        Schema::dropIfExists('_history_convert_data_ichijikins');
    }
    ...
    private function scheme(Blueprint $table, $is_history = false)
    {
        ...
        $table->string('image')->comment('Original Image');

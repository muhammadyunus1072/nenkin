...
class Exata extends Model
{
    ...
    const EXATA_FILTER_CHOICE = [
        ...
        'FILTER_' . self::PERMISSION_Gender => 'L / P',
    ...
    const EXATA_DATATABLE_CHOICE = [
        ...
        'DATATABLE_' . self::PERMISSION_Gender => 'L / P',
    ...
    const PIPELINE_BROADCAST = 'PIPELINE_BROADCAST';
    const PIPELINE_KONSULTASI = 'PIPELINE_KONSULTASI';
    const PIPELINE_ISI_GF = 'PIPELINE_ISI_GF';
    const PIPELINE_INTERVIEW_INTERN = 'PIPELINE_INTERVIEW_INTERN';
    const PIPELINE_INTERVIEW_USER = 'PIPELINE_INTERVIEW_USER';
    const PIPELINE_INTERVIEW_ULANG = 'PIPELINE_INTERVIEW_ULANG';
    const PIPELINE_PENEMPATAN = 'PIPELINE_PENEMPATAN';
    const PIPELINE_MASA_GARANSI = 'PIPELINE_MASA_GARANSI';
    const PIPELINE_RESIGN = 'PIPELINE_RESIGN';
    const PIPELINE_LOLOS_PROBATION = 'PIPELINE_LOLOS_PROBATION';
    const PIPELINE_CANCEL = 'PIPELINE_CANCEL';
    const FILTER_PIPELINE_CHOICE = [
        self::PIPELINE_NEW_LEADS => 'NEW LEADS',
        self::PIPELINE_BROADCAST => 'BROADCAST',
        self::PIPELINE_KONSULTASI => 'KONSULTASI',
        self::PIPELINE_ISI_GF => 'ISI GF',
        self::PIPELINE_INTERVIEW_INTERN => 'INTERVIEW INTERN',
        self::PIPELINE_INTERVIEW_USER => 'INTERVIEW USER',
        self::PIPELINE_INTERVIEW_ULANG => 'INTERVIEW ULANG',
        self::PIPELINE_PENEMPATAN => 'PENEMPATAN',
        self::PIPELINE_MASA_GARANSI => 'MASA GARANSI',
        self::PIPELINE_RESIGN => 'RESIGN',
        self::PIPELINE_LOLOS_PROBATION => 'LOLOS PROBATION',

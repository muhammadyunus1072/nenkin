...
class Datatable extends Component
{
        ...
        return [
            ...
            [
                ...
                'render' => function ($item) {
                    ...
                    return "<img src='" . $url . "' style='width:150px; height:auto; border:1px solid black; border-radius:5px;'><br>" . ($item->payment_top ? NumberFormatter::format($item->payment_top) : 'Kosong');
                }
            ],
            [
                'key' => 'payment',
                ...
                'render' => function ($item) {
                    ...
                    return "<img src='" . $url . "' style='width:150px; height:auto; border:1px solid black; border-radius:5px;'><br>" . NumberFormatter::format($item->payment);
                }
            ],
            [
                'key' => 'income',
                ...
                'render' => function ($item) {
                    ...
                    return "<img src='" . $url . "' style='width:150px; height:auto; border:1px solid black; border-radius:5px;'><br>" . NumberFormatter::format($item->income);
                }
            ],
            [
                'key' => 'net',
                ...
                'render' => function ($item) {
                    ...
                    return "<img src='" . $url . "' style='width:150px; height:auto; border:1px solid black; border-radius:5px;'><br>" . NumberFormatter::format($item->net);
                }
            ],
            [
                'key' => 'number',
    ...
    {
        return ConvertDataIchijikinRepository::datatable();
    }

    public function getView(): string
    {
        return 'livewire.convert-data-ichijikin.datatable';
    }
}

...
class Datatable extends Component
{
    ...
    public function getColumns(): array
    {
        return [
            ...
            [
                'searchable' => false,
                'sortable' => false,
                'name' => 'Maintance By Interval',
                'render' => function ($item) {
                    $html = '<ul class="list-group list-group-flush">';
                    foreach ($item->vehicleMaintenanceByIntervals as $service) {
                        $html .= "<li class='list-group-item'>$service->name Setiap $service->notif_interval X, Saat ini $service->current_interval X</li>";
                    }
            ...
            [
                'searchable' => false,
                'sortable' => false,
                'name' => 'Maintance By Odometer',
                'render' => function ($item) {
                    $html = '<ul class="list-group list-group-flush">';
                    foreach ($item->vehicleMaintenanceByOdometers as $service) {
                        $html .= "<li class='list-group-item'>$service->name Setiap $service->notif_odometer Km, Saat ini " . ($item->current_odometer - $service->latest_odometer) . "Km</li>";
                    }
    ...
    {
        return 'livewire.vehicle-management.vehicle.datatable';
    }
}

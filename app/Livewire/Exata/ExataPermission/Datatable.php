...
class Datatable extends Component
{
    ...
    public function onMount()
    {
        ...
        $this->isCanExataPermission = $authUser->hasPermissionTo(PermissionHelper::transform(PermissionHelper::ACCESS_EXATA_PERMISSION, PermissionHelper::TYPE_UPDATE));
        ...
        return [
            [
                ...
                'render' => function ($item) {
                    ...
                    $html = "<div class='row'>
                        $editHtml $exataPermissionHtml $destroyHtml 
                    </div>";
            ...
            [
                ...
                'render' => function ($item) {
                    ...
                    foreach ($item->permissions as $permission) {
                        ...
                        if (!str_starts_with($translatedName, 'exata_')) {

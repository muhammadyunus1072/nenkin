<div>
    ...
    <form wire:submit.prevent="store">
        <div class="position-relative">
            <div class="position-absolute border border-danger" style="top: 0; left: 0; right: 0; bottom: 0; display: flex; align-items: center; justify-content: center; background-color: rgba(255, 255, 255, 0.8); z-index: 10;" wire:loading>
                    <span class="text-white indicator-progress" > 

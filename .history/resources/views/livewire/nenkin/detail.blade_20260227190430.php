<div>
    ...
    <form wire:submit.prevent="store">
        <div class="position-relative">
            <div class="position-absolute border border-dnager">
                    <span class="text-white indicator-progress" > <i class="text-white indicator-progress animate-wand fas fa-wand-magic-sparkles text-white"></i> &nbsp; Sedang Memproses
                </span>
            </div>
            <div class="mb-3">
                <label>Images</label>

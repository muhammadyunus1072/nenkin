<div>
    <div class=" border border-danger">
        <p>HALO</p>
                    <p class="text-dark indicator-progress" style="font-size: 1.5rem; width: 100%; text-align: center;"> 
                        <i class="text-dark indicator-progress animate-wand fas fa-wand-magic-sparkles text-dark"></i> &nbsp; Sedang Memproses
                    </p>
            </div>

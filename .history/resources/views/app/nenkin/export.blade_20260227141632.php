...
<head>
    <title>{{ $request['sheet_title'] }}</title>
    <style>
        .table-border {
...
<body>
    ...
    <table class="table-border" style="width: 100%">
        <thead>
            ...
            <tr>
                <td colspan="22" style="font-weight: bold;">
                    Payor :{{ $request['payor']['payor_id'] .' - '. $request['payor']['payor_name'] }}
                </td>
            </tr>
            ...
            <tr>
                ...
                <th colspan="2">Pengajuan Pending</th>
                <th colspan="2">Pengajuan Dispute</th>
                <th colspan="3">Layak</th>
                <th colspan="2">Tidak Layak</th>
                <th colspan="2">Pending</th>
                <th colspan="2">Dispute</th>
                <th colspan="1">Selisih JR</th>
                <th colspan="1">Koreksi</th>

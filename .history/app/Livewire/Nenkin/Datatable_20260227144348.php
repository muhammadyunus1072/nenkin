        ...
        return [
            ...
            [
                ...
                'render' => function ($item) {
                    ...
                    return "<img src='" . $url . "' style='width:150px; height:auto; border:1px solid black; border-radius:5px;'><br>" . ($item->payment_top ? 'Kosong' : NumberFormatter::format($item->payment_top));
                }
            ],
            [
                'key' => 'payment',

            ...
            [
                ...
                'render' => function ($item) {
                    ...
                    $editHtml = "<div class='col-auto mb-2'>
                            <a class='btn btn-primary btn-sm' data-bs-toggle='modal' data-bs-target='#imageModal' wire:click=\"imageModal($item->image)\">
                    ...
                    $destroyHtml = "<div class='col-auto mb-2'>
                            <a class='btn btn-primary btn-sm' data-bs-toggle='modal' data-bs-target='#imageModal' wire:click=\"imageModal($item->id)\">
                                <i class='ki-duotone ki-eye fs-1'>
                                    <span class='path1'></span>
                                    <span class='path2'></span>
                                    <span class='path3'></span>

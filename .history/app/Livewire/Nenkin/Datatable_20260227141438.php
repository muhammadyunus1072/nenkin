...
class Datatable extends Component
{
    ...
    {
        $fileName = "Data Rekap Piutang $this->start_date sd $this->end_date";
        $payor = PetaKontraktorPayor::select('payor_id', 'payor_nm as payor_name')->where('payor_id', $this->filter_payor)->first();
        return ExportHelper::export(
            $type,
            $fileName,
            $this->data,
            'app.e-klaim.laporan.rekap-realisasi.export',
            [
                'title' => 'Data Rekap Piutang',
                'sheet_title' => 'Data',

...
class VisionOcrService
{
    ...
    public function drawLabelPfd($imagePath)
    {
        $pdf = new Fpdi();
        $pageWidth = 1130;
        $pageHeight = 1680;
        ...
        // Draw the base image
        $pdf->Image(storage_path('nenkin/84b237c0-0ef1-488c-99be-ed929d08168e/mg8IZ9CHdiIVV1d7nu5Pm26d7L06UGdtXraZInZI.jpg'), 0, 0, $pageWidth, $pageHeight);



        // Save the PDF
        $pdf->Output('F', public_path('labeled.pdf'));
    }
